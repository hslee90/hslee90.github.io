...
<div class="page-wrapper">
  ...
  <div class="main-content">
    <p>I'm a postdoctoral researcher specializing in <strong>Human-Computer Interaction (HCI)</strong>, <strong>Usable Privacy & Security</strong>, and <strong>Sociotechnical Systems</strong>. My research addresses a critical issue in the current landscape of data-rich environments (e.g., multimodal sensing, AI): *How 
      can we design user-centered systems that empower individuals to manage and reflect on their data, prioritizing privacy, mental well-being, and user control?*
