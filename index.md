...
<div class="page-wrapper">
  ...
  <div class="main-content">
    <p>I'm a researcher in <strong>Human-Computer Interaction (HCI)</strong> and <strong>Usable Privacy & Security</strong>. My research aims to address issues in the current landscape of data-rich environments (e.g., multimodal sensing, human-AI interaction): <i>How can we design user-centered systems that empower individuals to manage and reflect on their data, prioritizing privacy, mental well-being, and user control?</i></p>
